...
Personal **Linux** configuration files (dotfiles).

You are free to use as reference or starting point for your own setup.
Some adjustments may be necessary depending on your system.
